...
agent learns which prerequisite failures are recurring. Mirrors the
marathon-planner reference repo's auto_save_memories pattern, with topics
rewritten for procurement.
"""
